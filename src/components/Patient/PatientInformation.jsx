  ...
  return (
    <>
      <div style={{ float: "right" }}>
        <Button type="primary" onClick={() => setOpenModalPatient(true)} style={{ zIndex: "1",float: "right", marginBottom: "2px", marginTop: "60px", flex: "right" }} >
          Editar
        </Button>
      </div>
        <EditarPaciente
        ...
        <Row gutter={[16, 16]}>
          <Divider
            ...
            style={{
              fontWeight: "bold",
              marginTop: "20px", // Margen superior añadido
              marginBottom: "10px", // Margen inferior añadido
              zIndex: "2"
            }}
          >
            Informacion Basica
